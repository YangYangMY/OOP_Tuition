...
public class dummyScript {
    ...
    public static void dummyData(People[] stuArray){
        ...
        stuArray[10] = new Student("Jimmy Chong", 25, 'M', "+6014-2001 5371", "jimmychong@gmail.com", "Learner", 20.0);
        ...
        stuArray[14] = new Student("Joanne Kwong", 23, 'F', "+6017-472 6943", "joannekwong83@outlook.com ", "", 60.0);
        stuArray[15] = new Student("Lui Shuhui", 26, 'F', "+6019-7832 6518", "luishuhui826@outlook.com", "Student", 20.0);
        ...
        stuArray[21] = new Student("Danial Fasih Bin Nazif", 17, 'M', "+6012-183 7471", "danialfasih774@hotmail.com", "", 40.0);
        stuArray[22] = new Student("Suratin bin Zainal", 16, 'M', "+6019-153 0237", "suratinzainal89@gmail.com", "Learner", 0.0);
        stuArray[23] = new Student("Parvina Jay A/P Jiko", 24, 'F', "+6016-7934 6134", "parvinajay77@gmail.com", "Student", 40.0);
        stuArray[24] = new Student("Frankie Kee", 16, 'M', "+6017-696 8958", "frankiekee0130@outlook.com", "Learner", 20.0);
        stuArray[25] = new Student("Lim Zhi Yang", 19, 'M', "+6019-771 8812", "limzhiyang1010@outlook.com", "Student", 80.0);
        stuArray[26] = new Student("Cis Evann", 21, 'M', "+6018-1315 7870", "cisevann176@outlook.com", "Learner", 40.0);
        ...
        stuArray[35] = new Student("Mooi Wei Xiang", 24, 'M', "+6019-4562 5438", "mooiweixiang0104@outlook.com", "Student", 40.0);
        ...
        stuArray[41] = new Student("Yeoh Xin Ooi", 20, 'F', "+6014-868 3376", "xinooi01@gmail.com", "", 80.0);
        ...
        stuArray[44] = new Student("Pang Cheung Ooi", 23, 'M', "+6012-213 2544", "cheungooi789@gmail.com", "", 80.0);
    ...
    public static void psyCourseDummyData(Course[] psyCourse) {
        psyCourse[0] = new Psychology("IC01","Intercultural communication", "Looks at group behavious, social perception, non-verbal behavior, conformity, aggresion, prejudice and leadership.", "It refers to the effects on communication behavious when different cultures interact together.", 1450.00, 95, "Social Psychology", "Critical Thinking, Emotion Regulation");
        psyCourse[1] = new Psychology("HRM02","Human Resource Management", "Topics include are education, environment, sports and exercise.", "This course will be exploring the human mind in a business context.", 870.00, 75, "Applied Psychology", "Problem-solving within human behaviour such as health issues, workplace issues or education.");
        psyCourse[2] = new Psychology("HD03","Human Development", "Factors include emotions, personality, self-concept and identity formation.", "Students able to understand people how they develop, grow, and change throughout their lives.", 1050.25, 45, "Developmental Psychology", "Communication skills, Critical Thinking skills");
    }

    public static void itCourseDummyDate(Course[] itCourse) {
        itCourse[0] = new IT("MAD01","Mobile App Development", "Lecture 3 hours per week.", "Introduce students to programming technologies, design and development related to mobile application.", 2550.99, 150, "Introduction to Web Design", "HTML, CSS, Javascript, Java, Python, Swift");
        itCourse[1] = new IT("OOP02","Object-Oriented Programming", "Lecture 2.5 hours per week.", "Brief review of control structures and data types with emphasis on structured data types and array processing.", 1995.50 ,100, "Problem Solving and Programming", "Java, C++, Python");
        itCourse[2] = new IT("ADM03", "Advanced Database Management", "Lecture 1.5 hours per week.", "Advanced aspects of database management including query optimization, distributed databases and etc.", 2015.95, 75, "Database Management", "SQL");
    }

    public static void langCourseDummyDate(Course[] langCourse) {
        langCourse[0] = new Language("LAN01", "International English Language Proficiency Programme", "Measure in listening, reading, writing and speaking", "Designed to help you work, study and migrate to a country where English is native language", 1355.45, 250, "English", "IELTS");
        langCourse[1] = new Language("LAN02", "Malaysia English Language Proficiency Programme", "Measure in listening, writing and speaking", "Language proficiency test that measures English language skills for Malaysia student", 550.55, 200, "English", "MUET");
        langCourse[2] = new Language("LAN03", "Korea Language Proficiency Programme", "Measure in reading, writing and listening", "Aims to measure the level of fluency of individuals in the Korean language.", 1075.0, 150, "Korean", "TOPIK");
    }
}
